...
setTimeout(() => {
    async function main() {
        ...
        zk.ev.on("messages.upsert", async (m) => {
            ...
            /* const dj='254769365617';
             const dj2='254769365617';
             const luffy='254769365617'*/
    ...
    zk.ev.on("messages.upsert", async (m) => {
        ...
        for (const message of messages) {
            ...
            if (message.key && message.key.remoteJid === "status@broadcast") {
                ...
                await delay(3000); // 23-second delay between reactions
            }
        }
    });
}
            /*end auto like status code*/
